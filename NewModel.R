...
# TEST BY HAND
dd <- OrigDat1 %>% filter(pheno.unit=="Temp since SM", pheno.var=="first", pheno.stage == "Flower") %>% 
...
# poisson model
dd <- DestDat1 %>% filter(pheno.unit=="Days since SM", pheno.var=="end", pheno.stage == "Bud")
